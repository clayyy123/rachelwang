...
class Blog extends Component {
  ...
  deleteHandler(id) {
    httpClient.deletePost(id).then(serverResponse => {
      console.log(serverResponse);
      this.setState({
        blogposts: this.state.blogposts.filter(
          post => post._id !== serverResponse.data.blog._id
        ),
        modal: !this.state.modal
      });
    });
              ...
              return (
                <div>
                    ...
                    >
                      ...
                      <ModalFooter>
                        <Button
                          color="primary"
                          onClick={() =>
                            this.deleteHandler(this.state.selectedBlog._id)
                          }
                        >
                          Delete
                        </Button>
                  ...
                  {!this.state.blogposts[0] ? (
                    <h1 id="coming-soon-font"> Blog Posts Coming Soon! </h1>
                  ) : (
                    <div />
                  )}
