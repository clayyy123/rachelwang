...
class Contact extends Component {
  ...
  onSubmitHandler (evt){
    evt.preventDefault()
    if (!this.state.fields.name || !this.state.fields.email || !this.state.fields.subject || !this.state.fields.message){
      this.setState({
  ...
  render(){
    return(
      ...
      <div className="offset">
        ...
        <Row>
          <Col sm="6" md={{size:6}}><h5>Feel free to reach out and ask questions through the form!</h5> 
